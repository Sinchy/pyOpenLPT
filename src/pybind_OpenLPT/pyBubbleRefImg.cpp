  ...
  py::class_<BubbleRefImg>(m, "BubbleRefImg")
      ...
      .def(
          ...
          [](BubbleRefImg &self,
             ...
             const std::vector<Camera> &cams, const std::vector<Image> &images,
            ...
            bool ok = self.calBubbleRefImg(objs3d_uq, objs2d_uq, cams, images,
                                           output_folder, r_thres, n_bb_thres);
            if (!ok)
